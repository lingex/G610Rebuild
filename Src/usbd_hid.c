...
__ALIGN_BEGIN static uint8_t HID_ReportDesc[]  __ALIGN_END =
{
	...
	0x15, 0x00,	//   Logical Minimum (0),
	0x25, 0x01,	//   Logical Maximum (1),
	0x81, 0x00,        //   Input (Data,Array,Abs,No Wrap,Linear,Preferred State,No Null Position) ;Modifier byte
	// LED output report
	...
	// bitmap of keys
	0x95, NKRO_KEYS * 8,    	//   Report Count (),		key count
	0x75, 0x01,             	//   Report Size (1),				1key:1bit
	0x15, 0x00,             	//   Logical Minimum (0),
	0x25, 0x01,             	//   Logical Maximum(1),
	0x05, 0x07,             	//   Usage Page (Key Codes),
...
__ALIGN_BEGIN static uint8_t USBD_HID_CfgDesc[USB_HID_CONFIG_DESC_SIZ]  __ALIGN_END =
{
  ...
  (uint8_t)sizeof(HID_ReportDesc),/*wItemLength: Total length of Report descriptor*/
  0x00,
  ...
  7,                    // bLength
  USB_DESC_TYPE_ENDPOINT,                    // bDescriptorType
  HID_EPIN_ADDR_2, // bEndpointAddress
  0x03,                 // bmAttributes (0x03=intr)
  NKRO_SIZE + 8,          // wMaxPacketSize
  0,
  HID_HS_BINTERVAL,     // bInterval (1 ms)
#endif
