##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.13.0-B3] date: [Tue Mar 30 23:08:15 CST 2021] 
##########################################################################################################################
...
# link script
ifeq ($(DEBUG), 1)
LDSCRIPT = STM32L100R8Tx_FLASH.ld
else
LDSCRIPT = STM32L100R8Tx_FLASH_WITH_BOOTLOADER.ld
endif
