...
__ALIGN_BEGIN static uint8_t USBD_HID_CfgFSDesc[USB_HID_CONFIG_DESC_SIZ]  __ALIGN_END =
{
	...
	/*** Descriptor of Joystick Mouse interface [/b][/b][/b][/b]********/
	/* 09 */
	...
	/****** Descriptor of Joystick Mouse HID [/b][/b][/b][/b][/b]**********/
	/* 18 */
	...
	0x00,
	/****** Descriptor of Mouse endpoint [/b][/b][/b][/b][/b]**********/
	/* 27 */
...
static uint8_t  USBD_HID_DataOut(USBD_HandleTypeDef *pdev, uint8_t epnum)
{
	...
	SetNumLockLED(rx_buf & 0x01);
	SetCapsLockLED(rx_buf & 0x02);
	SetScrollLockLED(rx_buf & 0x04);
